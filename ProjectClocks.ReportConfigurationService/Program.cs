...
using ProjectClocks.ReportConfigurationService.Repositories;
...
// This service will run on port 5006
...
{
    c.SwaggerDoc("v1", new() { Title = "Report Configuration Service API", Version = "v1" });
...
// Register the ReportConfigurationRepository for use at runtime as a scoped dependency
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Project Clocks - Report Configuration Service API Version 1");
