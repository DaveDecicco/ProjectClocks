...
using ProjectClocks.UserProjectService.Repositories;
...
// This service will run on port 5010
...
{
    c.SwaggerDoc("v1", new() { Title = "User Project Service API", Version = "v1" });
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Project Clocks - User Project Service API Version 1");
