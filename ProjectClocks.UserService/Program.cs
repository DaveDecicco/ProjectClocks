...
using ProjectClocks.UserService.Repositories;
...
// This service will run on port 5009
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Project Clocks - User Service API Version 1");
