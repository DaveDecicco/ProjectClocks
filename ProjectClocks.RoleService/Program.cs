...
using ProjectClocks.RoleService.Repositories;
...
// This service will run on port 5007
...
{
    c.SwaggerDoc("v1", new() { Title = "Role Service API", Version = "v1" });
...
// Register the RoleRepository for use at runtime as a scoped dependency
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Project Clocks - Role Service API Version 1");
