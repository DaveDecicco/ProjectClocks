...
using ProjectClocks.InvoiceService.Repositories;
...
// This service will run on port 5004
...
{
    c.SwaggerDoc("v1", new() { Title = "Invoice Service API", Version = "v1" });
...
// Register the InvoiceRepository for use at runtime as a scoped dependency
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Project Clocks - Invoice Service API Version 1");
