...
using ProjectClocks.ProjectService.Repositories;
...
// This service will run on port 5005
...
// Register the ProjectRepository for use at runtime as a scoped dependency
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Project Clocks - Project Service API Version 1");
