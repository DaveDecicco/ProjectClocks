...
using ProjectClocks.UserTimeEntryService.Repositories;
...
// This service will run on port 5011
...
{
    c.SwaggerDoc("v1", new() { Title = "User Time Entry Service API", Version = "v1" });
...
// Register the UserRepository for use at runtime as a scoped dependency
builder.Services.AddScoped<IUserTimeEntryRepository, UserTimeEntryRepository>();
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Project Clocks - User Time Entry Service API Version 1");
