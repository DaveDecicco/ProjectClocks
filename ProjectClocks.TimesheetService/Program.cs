...
using ProjectClocks.TimesheetService.Repositories;
...
// This service will run on port 5012
builder.WebHost.UseUrls("https://localhost:5012");
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Project Clocks - Time Sheet Service API Version 1");
