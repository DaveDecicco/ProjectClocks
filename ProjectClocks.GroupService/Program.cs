...
using ProjectClocks.GroupService.Repositories;
...
// This service will run on port 5003
...
{
    c.SwaggerDoc("v1", new() { Title = "Group Service API", Version = "v1" });
...
// Register the GroupRepository for use at runtime as a scoped dependency
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Project Clocks - Group Service API Version 1");
